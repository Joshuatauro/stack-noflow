...
const Navbar = () => {
  ...
  return (
    <nav className="w-full border-b bg-white dark:bg-dark sticky z-50 top-0 border-cta border-b-gray-500 transition duration-300 ">
      <div className=" px-6  h-16 dark:border-dark-text grid grid-cols-11 items-center  m-auto">
        <div className=" items-center w-full mr-2 col-span-8">
          <div className="flex items-center  ">
            ...
            <input type="text" placeholder="Search anything here....." className="w-full h-11 px-4 focus:outline-gray-800 outline outline-1 outline-gray-400 rounded-md text-sm font-normal placeholder:text-gray-600 dark:bg-dark transition duration-300" />
          </div>
        </div>
          ...
          isLoggedIn ? (
            <div className="flex w-full items-center justify-end">
              <button  className="flex items-center">
                <h1 className="text-sm font-medium text-gray-600 ml-1.5 mr-1 dark:text-white">{username}</h1>
              ...
              <Link to="/settings"><CogIcon className='h-[1.4rem] dark:text-white mr-2' /></Link>
